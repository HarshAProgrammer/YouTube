...
public final class FeedDAO_Impl extends FeedDAO {
  ...
  public FeedDAO_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfFeedLastUpdatedEntity = new EntityInsertionAdapter<FeedLastUpdatedEntity>(__db) {
      ...
      public void bind(SupportSQLiteStatement stmt, FeedLastUpdatedEntity value) {
        ...
        final Long _tmp;
        _tmp = Converters.INSTANCE.offsetDateTimeToTimestamp(value.getLastUpdated());
        if (_tmp == null) {
          stmt.bindNull(2);
        } else {
  ...
  public void unlinkStreamsOlderThan(final OffsetDateTime offsetDateTime) {
    ...
    int _argIndex = 1;
    final Long _tmp;
    _tmp = Converters.INSTANCE.offsetDateTimeToTimestamp(offsetDateTime);
    if (_tmp == null) {
  ...
  @Override
  public Flowable<List<StreamWithState>> getAllStreams() {
    final String _sql = "\n"
    ...
    return RxRoom.createFlowable(__db, false, new String[]{"streams","stream_state","stream_history","feed"}, new Callable<List<StreamWithState>>() {
      @Override
  ...
  @Override
  public Flowable<List<StreamWithState>> getAllStreamsForGroup(final long groupId) {
    final String _sql = "\n"
            + "        SELECT s.*, sst.progress_time\n"
            + "        FROM streams s\n"
            + "\n"
    ...
    return RxRoom.createFlowable(__db, false, new String[]{"streams","stream_state","stream_history","feed","feed_group_subscription_join"}, new Callable<List<StreamWithState>>() {
      @Override
      public List<StreamWithState> call() throws Exception {
        final Cursor _cursor = DBUtil.query(__db, _statement, false, null);
        try {
  ...
  @Override
  public Flowable<List<StreamWithState>> getLiveOrNotPlayedStreams() {
    final String _sql = "\n"
            + "        SELECT s.*, sst.progress_time\n"
            + "        FROM streams s\n"
            + "\n"
  ...
  @Override
  public Flowable<List<StreamWithState>> getLiveOrNotPlayedStreamsForGroup(final long groupId) {
    final String _sql = "\n"
            + "        SELECT s.*, sst.progress_time\n"
            + "        FROM streams s\n"
            + "\n"
  ...
  public Flowable<List<SubscriptionEntity>> getAllOutdated(final OffsetDateTime outdatedThreshold) {
    ...
    int _argIndex = 1;
    final Long _tmp;
    _tmp = Converters.INSTANCE.offsetDateTimeToTimestamp(outdatedThreshold);
    if (_tmp == null) {
