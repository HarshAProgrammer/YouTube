...
public final class FragmentFeedBinding implements ViewBinding {
  ...
  private FragmentFeedBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull TextView loadingProgressText, @NonNull ImageView refreshIcon,
      @NonNull LinearLayout refreshInfoContainer, @NonNull RelativeLayout refreshRootView,
      @NonNull TextView refreshSubtitleText, @NonNull TextView refreshText,
  ...
  public static FragmentFeedBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      TextView loadingProgressText = ViewBindings.findChildViewById(rootView, id);
      ...
      TextView refreshSubtitleText = ViewBindings.findChildViewById(rootView, id);
      if (refreshSubtitleText == null) {
        break missingId;
      }

      id = R.id.refresh_text;
      TextView refreshText = ViewBindings.findChildViewById(rootView, id);
      if (refreshText == null) {
        break missingId;
      }
      ...
      return new FragmentFeedBinding((RelativeLayout) rootView, binding_emptyStateView,
          binding_errorPanel, itemsList, loadingProgressBar, loadingProgressText, refreshIcon,
          refreshInfoContainer, refreshRootView, refreshSubtitleText, refreshText,
          swipeRefreshLayout);
    }
