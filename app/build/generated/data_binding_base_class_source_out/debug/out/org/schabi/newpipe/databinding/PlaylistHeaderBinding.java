...
public final class PlaylistHeaderBinding implements ViewBinding {
  ...
  public static PlaylistHeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      TextView playlistStreamCount = ViewBindings.findChildViewById(rootView, id);
      if (playlistStreamCount == null) {
        break missingId;
      }

      id = R.id.playlist_title_view;
      TextView playlistTitleView = ViewBindings.findChildViewById(rootView, id);
      if (playlistTitleView == null) {
        break missingId;
      }

      id = R.id.uploader_avatar_view;
      CircleImageView uploaderAvatarView = ViewBindings.findChildViewById(rootView, id);
      ...
      TextView uploaderName = ViewBindings.findChildViewById(rootView, id);
