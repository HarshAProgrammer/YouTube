...
public final class ChannelHeaderBinding implements ViewBinding {
  ...
  private ChannelHeaderBinding(@NonNull RelativeLayout rootView, @NonNull FrameLayout avatarsLayout,
      ...
      @NonNull TextView channelSubscriberView, @NonNull TextView channelTitleView,
  ...
  public static ChannelHeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      CircleImageView channelAvatarView = ViewBindings.findChildViewById(rootView, id);
      ...
      TextView channelSubscriberView = ViewBindings.findChildViewById(rootView, id);
      if (channelSubscriberView == null) {
        break missingId;
      }

      id = R.id.channel_title_view;
      TextView channelTitleView = ViewBindings.findChildViewById(rootView, id);
      ...
      CircleImageView subChannelAvatarView = ViewBindings.findChildViewById(rootView, id);
      if (subChannelAvatarView == null) {
        break missingId;
      }

      id = R.id.sub_channel_title_view;
      TextView subChannelTitleView = ViewBindings.findChildViewById(rootView, id);
