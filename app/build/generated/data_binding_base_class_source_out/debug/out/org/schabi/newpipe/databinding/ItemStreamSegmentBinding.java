...
public final class ItemStreamSegmentBinding implements ViewBinding {
  ...
  private ItemStreamSegmentBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView previewImage, @NonNull TextView textViewChannel,
      @NonNull TextView textViewStartSeconds, @NonNull TextView textViewTitle) {
  ...
  public static ItemStreamSegmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      TextView textViewChannel = ViewBindings.findChildViewById(rootView, id);
      if (textViewChannel == null) {
        break missingId;
      }

      id = R.id.textViewStartSeconds;
      TextView textViewStartSeconds = ViewBindings.findChildViewById(rootView, id);
