...
public final class FragmentDescriptionBinding implements ViewBinding {
  ...
  private FragmentDescriptionBinding(@NonNull NestedScrollView rootView, @NonNull Barrier barrier,
      @NonNull TextView detailDescriptionNoteView, @NonNull TextView detailDescriptionView,
      @NonNull LinearLayout detailMetadataLayout, @NonNull ImageView detailSelectDescriptionButton,
      @NonNull TextView detailUploadDateView) {
  ...
  public static FragmentDescriptionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      TextView detailDescriptionNoteView = ViewBindings.findChildViewById(rootView, id);
      if (detailDescriptionNoteView == null) {
        break missingId;
      }

      id = R.id.detail_description_view;
      TextView detailDescriptionView = ViewBindings.findChildViewById(rootView, id);
      ...
      TextView detailUploadDateView = ViewBindings.findChildViewById(rootView, id);
