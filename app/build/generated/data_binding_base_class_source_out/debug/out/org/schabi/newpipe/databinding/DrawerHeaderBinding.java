...
public final class DrawerHeaderBinding implements ViewBinding {
  ...
  private DrawerHeaderBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView drawerArrow,
      @NonNull Button drawerHeaderActionButton, @NonNull TextView drawerHeaderNewpipeTitle,
      @NonNull ImageView drawerHeaderServiceIcon, @NonNull TextView drawerHeaderServiceView) {
  ...
  public static DrawerHeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      TextView drawerHeaderNewpipeTitle = ViewBindings.findChildViewById(rootView, id);
      ...
      TextView drawerHeaderServiceView = ViewBindings.findChildViewById(rootView, id);
