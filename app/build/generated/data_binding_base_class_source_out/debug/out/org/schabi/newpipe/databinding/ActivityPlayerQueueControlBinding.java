...
public final class ActivityPlayerQueueControlBinding implements ViewBinding {
  ...
  public static ActivityPlayerQueueControlBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.center;
      RelativeLayout center = ViewBindings.findChildViewById(rootView, id);
      ...
      id = R.id.live_sync;
      TextView liveSync = ViewBindings.findChildViewById(rootView, id);
      if (liveSync == null) {
        break missingId;
      }
      ...
      TextView seekDisplay = ViewBindings.findChildViewById(rootView, id);
      if (seekDisplay == null) {
        break missingId;
      }
